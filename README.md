...
I'm a Ghanaian software developer focused on building practical web applications, REST APIs, and software systems that solve real-world problems.
...
**Stack:** Python, FastAPI, SQLAlchemy, PostgreSQL, Pydantic, JWT, bcrypt, Alembic and Pytest.

**Engineering focus:** atomic transactions, row locking, idempotency, rollback, auditability and reliable transfer processing.
